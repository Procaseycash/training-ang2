...
==========================================================================================*/
var btcChartjs = null, a = null, t1 = 0, t2 = 0;
(function(window, document, $) {
  ...
  t1 = setInterval(() => {
    ...
    ********************************************/
    ...
    btcChartjs = document.getElementById("btc-chartjs").getContext("2d");
...
$(window).on("load", function(){
  ...
  var a = document.getElementById('btc-candlestick-control');
    // Set paths
    // ------------------------------
